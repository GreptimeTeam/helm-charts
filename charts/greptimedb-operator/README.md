...
![Version: 0.1.8](https://img.shields.io/badge/Version-0.1.8-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.1.0-alpha.21](https://img.shields.io/badge/AppVersion-0.1.0--alpha.21-informational?style=flat-square)
...
| image.tag | string | `"0.1.0-alpha.21"` | The image tag |
