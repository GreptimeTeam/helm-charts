...
| auditLog.classes | string | `"ddl,admin"` | Allowed statement classes for auditing. This option acts as a filter. Multiple classes are separated by commas (","). Available classes: "read", "write", "admin", "ddl", "misc". A special value "all" means all classes. Default: "ddl,admin". |
| auditLog.commands | string | `"all"` | Allowed statement commands for auditing. This option acts as a filter. Multiple commands are separated by commas (","). Available commands: "promql", "select", "copy", "insert", "delete", "create", "alter", "truncate", "drop", "admin", "misc". A special value "all" (default) means all commands. |
| auditLog.dir | string | `"/data/greptimedb/audit-logs"` | Directory to store audit log files. Default: "/data/greptimedb/audit-logs". |
...
| auditLog.objectTypes | string | `"all"` | Allowed object types for auditing. This option acts as a filter. Multiple object types are separated by commas (","). Available object types: "database", "table", "view", "flow", "index", "misc", "trigger". A special value "all" (default) means all object types. |
| auditLog.sources | string | `"all"` | Allowed sources for auditing. This option acts as a filter. Multiple sources are separated by commas (","). Available sources: "unknown", "http", "grpc", "mysql", "postgres". A special value "all" (default) means all sources. |
