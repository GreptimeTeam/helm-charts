...
![Version: 0.7.4](https://img.shields.io/badge/Version-0.7.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0-beta.3](https://img.shields.io/badge/AppVersion-1.0.0--beta.3-informational?style=flat-square)
...
| image.tag | string | `"v1.0.0-beta.3"` | The image tag |
