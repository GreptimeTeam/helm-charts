...
![Version: 0.8.35](https://img.shields.io/badge/Version-0.8.35-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.3.0-alpha.1](https://img.shields.io/badge/AppVersion-1.3.0--alpha.1-informational?style=flat-square)
...
| auditLog.dir | string | `"/data/greptimedb/audit-logs"` | Directory to store audit log files. |
...
| image.tag | string | `"v1.3.0-alpha.1"` | The image tag |
